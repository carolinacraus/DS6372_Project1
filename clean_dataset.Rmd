...
<h4>*Interpretation of Coefficients & Confidence Intervals:*</h4>
...
<h4>*Practical Significance | Year Predictor:*</h4>
...
<h4>*Practical Significance | Log Engine Horse Power Predictor:*</h4>
...
<h4>*Statistical Significance | Year Predictor:*</h4>
...
<h4>*Statistical Significance | Log Engine Horse Power Predictor:*</h4>
- At an alpha = .05 level of significance there is an overwhelming amount of evidence to suggest that 
the Year coefficient is different than zero (p-value < .0001). 
```{r, message=FALSE, warning=FALSE, fig.align='center'}
# removing MSRP 
