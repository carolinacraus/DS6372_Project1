...
ANOVA Testing
```{r}
aov_1 <- aov(log_Engine.HP~Vehicle.Size, backup_df)
summary(aov_1)

aov_2 <- aov(log_Engine.HP~Make, backup_df)
summary(aov_2)

aov_3 <- aov(log_Engine.HP~Engine.Cylinders, backup_df)
summary(aov_3)
...
```{r}
reg.fwd = regsubsets(log_MSRP~., data = backup_df, method="forward", nvmax = 16)
summary(reg.fwd)$bic
