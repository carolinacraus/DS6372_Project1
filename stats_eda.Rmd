...
upon further investigation we find that there are man "N/A" values within the 
Market.Category column (3742). 
For now we will proceed to visually inspect the data. 
```{r}
