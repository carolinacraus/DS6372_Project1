...
we could possibly create a ML algo to predict what the HP is... but since they are reported on a differnet scale, and are of a differnt type of vehicle
...
Market.Category column (3742) which could in fact mean there is no applicable group that it fits into. we
will change this N/A to "No Category"
